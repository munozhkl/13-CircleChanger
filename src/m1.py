...
class CircleChanger(object):
    ...
    def __init__(self, x, y, radius, fill_color, colors):
        ...
        self.circle.fill_color_original = fill_color
        self.count = 0
    ...
    def get_distance_from(self, point):
        ...
        ################################################################
        self.distance_from_centerto_point = point.get_distance_from(self.circle.center)
        return self.distance_from_centerto_point
    ...
    def swallow(self, other_circle_changer):
        ...
        #   NO CREDIT if you use the distance formula here.
        ################################################################
        newcirclechanger = CircleChanger((self.circle.center.x + other_circle_changer.circle.center.x) / 2,
    ...
    def change_to_original_color(self):
        ...
        #   (below).  Third, implement and test this method.
        ################################################################
        self.circle.fill_color = self.circle.fill_color_original
